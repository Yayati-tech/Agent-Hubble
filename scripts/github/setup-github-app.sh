...
# GitHub App Setup Script for Security Hub Ticketing
# This script guides you through setting up GitHub App authentication
...
echo -e "${BLUE}🔧 GitHub App Setup for Security Hub Ticketing${NC}"
echo -e "${BLUE}================================================${NC}"
...
echo -e "${YELLOW}🔄 Updating Lambda function with GitHub App configuration...${NC}"
...
echo -e "${GREEN}✅ Lambda function updated with GitHub App configuration${NC}"
...
cat > github-app-dashboard.json << EOF
{
    "widgets": [
        {
            "type": "metric",
...
echo -e "${GREEN}✅ CloudWatch dashboard created: GitHubAppDashboard${NC}"
...
echo -e "  - CloudWatch Dashboard: GitHubAppDashboard"
echo ""
